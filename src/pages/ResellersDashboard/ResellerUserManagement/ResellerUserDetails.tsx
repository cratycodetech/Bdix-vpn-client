...
import {
  ...
  const ResellerUserDetails = ({list} : {list: any}) => {
    // console.log(list);
    const {
      _id,
      createdAt,
              ...
              <AlertDialogContent className="border">
                ...
                <ScrollArea className="h-[440px] overflow-y-auto ">
                  <div className="flex items-center justify-start gap-5 px-4">
                    ...
                    <div>
                      <h1 className="text-[#23272E] font-semibold text-xl">{_id}</h1>
                  ...
                  <div className="">
                    <div className="flex items-center justify-center gap-3">
                      ...
                      <p className="text-[#3B3B3B] font-medium text-lg">{userId?.email}</p>
                    </div>
                    <div className="flex items-center justify-center pr-24 mt-3 gap-3">
                      <FaPhone className="text-[#3B3B3B] h-[20px] w-[20px]" />
                      <p className="text-[#3B3B3B] font-medium text-xl">{userId?.phone}</p>
                    </div>
                  </div>
                    ...
                    <div className="mt-2 flex items-center justify-start gap-10">
                        <div>
                            <div>
                                ...
                                <h2 className="text-[#2B2D42] font-semibold text-xl">{userId?.name}</h2>
                            </div>
                        </div>
                    </div>
                  </div>
                    ...
                    <div className="mt-2 flex items-center justify-start gap-10">
                        <div>
                            ...
                            <div className="mt-4">
                                ...
                                <h2 className="text-[#737373] font-semibold text-xl">{resellerName}</h2>
                            </div>
                        </div>
                        <div>
                            <div>
                                <h1 className="text-[#3B3B3B] text-xl">Credit Score</h1>
                                <h2 className="text-[#737373] font-semibold text-xl">{credits} / 500</h2>
                            </div>
                        </div>
                    </div>
  ...
  export default ResellerUserDetails;