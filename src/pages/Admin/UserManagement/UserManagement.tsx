...
} from "@/pages/redux/features/admin/PremiumUser/PremiumUserApi";
import {
  useGetAllUsersQuery,
  useUpdateUserRoleMutation,
} from "@/pages/redux/features/admin/adminUserManagement/adminUserManagementApi";
    ...
    <div>
      <div className="flex flex-col lg:flex-row gap-5">
        <div className="w-full lg:w-1/2">
          <h1 className="text-[#000000] text-2xl font-medium mb-2">
            {getAllPremiumUser?.data?.length} Premium User
          </h1>
        ...
        <div className="mt-2 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 items-center justify-between gap-5">
            ...
            >
              ...
              <SelectContent>
                <SelectGroup>
                  ...
                  {combinedUserData?.map((user: any) => (
                    <SelectItem
                      key={user.resellerReference}
                      value={user.resellerReference}
                    >
          ...
          <div className="xl:flex xl:place-content-end">
            <Button
              ...
              className="bg-[#4406CB] text-[#FFFFFF] font-semibold text-lg leading-6 py-6"
            >
              Reset Filter
            </Button>
          </div>
            ...
            <Table>
              ...
              <TableHeader className="bg-[#F0F4FA]">
                <TableRow className="border-b border-[#DBDADE]">
                  ...
                  <TableHead className="text-[#000000] font-medium text-base text-center">
                    Update Role
                  </TableHead>
                  <TableHead className="text-[#000000] font-medium text-base text-center">
                    Action
                ...
                {filteredUsers?.map((list: any) => (
                  <TableRow key={list._id}>
                    ...
                    <TableCell>
                      <Select
                        onValueChange={(value) => {
                          handleUpdateUserRole(list?.userId, value);
                        }}
                      >
                        <SelectTrigger className="w-[100px] border-none">
                          <SelectValue placeholder={list?.role} />
                        </SelectTrigger>
                        <SelectContent>
                          <SelectGroup>
